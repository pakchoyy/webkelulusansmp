  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-8 mb-6 text-center space-y-3">
        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Butuh bantuan?</p>
        <a 
          href="https://wa.me/6289530713597?text=Halo%20Pak%20Choy%2C%20saya%20butuh%20bantuan%20terkait%20dashboard%20kelulusan%20SMP"
          target="_blank"
          className="inline-flex items-center gap-2 bg-[#25d366] hover:bg-[#20ba56] text-white font-black px-6 py-3 rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-lg shadow-green-200"
        >
